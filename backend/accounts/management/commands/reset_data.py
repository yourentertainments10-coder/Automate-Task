...
REAL_TEAM = [
    ...
    ("Mahesh", "maheshshokeen6@gmail.com", "mahesh", "Mahesh", "", Role.SALES_EXECUTIVE, "sales"),
    ...
    ("Rahul Bhandari", "rahul.bhandari@cartrends.in", "rahul.bhandari", "Rahul", "Bhandari", Role.SALES_EXECUTIVE, "sales"),
    ("Rahul Sinha", "Bijwasan@cartrends.net", "rahul.sinha", "Rahul", "Sinha", Role.SALES_EXECUTIVE, "sales"),
    ("Rahul Thakur", "rahulthakur3928@gmail.com", "rahul.thakur", "Rahul", "Thakur", Role.SALES_EXECUTIVE, "sales"),
