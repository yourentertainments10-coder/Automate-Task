...
REAL_TEAM = [
    ...
    ("Jaibir Singla", "jaibir.jitu@cartrends.in", "jaibir", "Jaibir", "Singla", Role.SALES_EXECUTIVE, "sales"),
    ...
    ("Nirmal Singla", "nirmal.singla@cartrends.in", "nirmal", "Nirmal", "Singla", Role.SALES_EXECUTIVE, "sales"),
    ...
    ("Surendra Shyoran", "surendra.shyoran@cartrends.in", "surendra", "Surendra", "Shyoran", Role.ACCOUNTS, "accounts"),
